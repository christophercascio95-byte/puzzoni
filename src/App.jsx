            ...
            <div>
              <div style={{padding:"0 12px"}}>
                ...
                <div style={{position:"relative",marginTop:8}}>
                  {Array.from({length:24},(_,h)=>(
                    <div key={h} onClick={()=>{const d=new Date(curDate);d.setHours(h,0,0);const ev2={...emptyEv,date:toIsoDate(curDate),timeFrom:`${String(h).padStart(2,"0")}:00`};setNewEv(ev2);setShowAdd(true);}} style={{display:"flex",gap:8,height:PX_PER_HOUR,borderTop:`1px solid ${P.mintLight}`,cursor:"pointer"}}>
